...
# Gene universe used for GO enrichment when `universe_value_module` is provided (see YAML).
# If not NULL, enrichment is run against all genes in this universe.
universe_ids <- all.markers_overall$gene
universe_ids <- as.character(universe_ids)
...
# Gene universe used for GO enrichment when `universe_value_module` is provided (see YAML).
# If not NULL, enrichment is run against all genes in this universe.
universe_ids <- all.markers_condition_value1$gene
universe_ids <- as.character(universe_ids)
universe_ids <- universe_ids[!is.na(universe_ids) & universe_ids != ""]
...
if (!is.null(condition_value2)) {
  ...
  # Gene universe used for GO enrichment when `universe_value_module` is provided (see YAML).
  # If not NULL, enrichment is run against all genes in this universe.
  universe_ids <- all.markers_condition_value2$gene
  universe_ids <- as.character(universe_ids)
  universe_ids <- universe_ids[!is.na(universe_ids) & universe_ids != ""]
...
if (!is.null(condition_value3)) {
  ...
  # Gene universe used for GO enrichment when `universe_value_module` is provided (see YAML).
  # If not NULL, enrichment is run against all genes in this universe.
  universe_ids <- all.markers_condition_value3$gene
  universe_ids <- as.character(universe_ids)
  universe_ids <- universe_ids[!is.na(universe_ids) & universe_ids != ""]
